...
def get_args():
    ...
    parser.add_argument('-i', '--input', type=str, default='./inputs/', dest='input')


    parser.add_argument('-o', '--output', type=str,default='result', dest='output')
    
    parser.add_argument('-a', '--anatomy', type=str, default='all', dest='anatomy')
...
if __name__ == '__main__':
    ...
    if args.anatomy == 'all':
        n_classes = 15 # 14 organs + background
    else:
        n_classes = 1        
    ...
    try:
        ...
        args.output += 'flare23-'+args.anatomy+'-n-'+str(args.network)+'-e-'+str(args.epochs)+'-b-'+str(args.batch)
